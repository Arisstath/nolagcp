		...
		<div class="row clearfix">
			<div class="col-lg-9 col-md-8 col-xs-12">
				<div class="l-detail">
                            ...
                            <h3>Sign up to start your own Minecraft community</h3>
                            <p>The leading custom panel in the industry.</p>                            
			...
			<div class="col-lg-3 col-md-4 col-xs-12">
				<div class="card">
					...
					<div class="form-group form-float">
                            ...
                            <a onclick="submitLogin();" class="btn btn-raised waves-effect bg-red" type="submit">Register</a> <a href="login" class="btn btn-raised waves-effect" type="submit">Login</a>
